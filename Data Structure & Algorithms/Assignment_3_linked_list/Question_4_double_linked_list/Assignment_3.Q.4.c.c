...
int main(){
    ...
    head = insert(head,5);
    head = insert(head,56);
    head0 = insert(head0,5);
    head0 = insert(head0,56);
    head0 = insert(head0,56);
    head0 = insert(head0,56);
    head0 = insert(head0,56);
    printf("Your Original Doubly Linked list1 is like this:: \n\t");
    print_list(head);
    printf("\nYour Original Doubly Linked list2 is like this:: \n\t");
    print_list(head0);
