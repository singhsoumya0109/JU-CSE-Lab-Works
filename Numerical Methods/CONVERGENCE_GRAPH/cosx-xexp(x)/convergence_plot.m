M1=dlmread('cosx-xexp(x)_bisection.txt'); % reading the matrix of data from the file
M2=dlmread('cosx-xexp(x)_falsi.txt'); % reading the matrix of data from the file
