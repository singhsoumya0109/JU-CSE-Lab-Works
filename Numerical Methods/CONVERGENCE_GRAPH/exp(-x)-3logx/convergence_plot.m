M1=dlmread('exp(-x)-3logx_bisection.txt'); % reading the matrix of data from the file
M2=dlmread('exp(-x)-3logx_falsi.txt'); % reading the matrix of data from the file
